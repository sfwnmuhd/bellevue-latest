    ...
    <div className="mt-5">
      ...
      >
        ...
        <input
          ...
          className="w-full max-w-[250px] rounded-md border border-black/15 bg-white/70 px-3 py-2.5 text-sm outline-none transition-[border-color,box-shadow] focus:border-brand-dark focus:ring-2 focus:ring-brand-dark/20 sm:w-[220px]"
        />
        <motion.button
          type="submit"
